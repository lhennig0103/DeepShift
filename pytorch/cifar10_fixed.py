...
def main():
    cfg = {
    'activation_fraction_bits': 19,
    'activation_integer_bits': 22,
    'batch_size': 412,
    'epochs': 47,
    'lr': 0.19574505010432006,  # Learning rate
    'momentum': 0.5759289191947714,
    'optimizer': 'Adam',  # Adam optimizer
    'rounding': 'stochastic',
    'shift_depth': 7,
    'shift_type': 'PS',
    'test_batch_size': 1355,
    'weight_bits': 3,
    'weight_decay': 0.0015905368668715518
}
